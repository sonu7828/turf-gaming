    ...
    return (
        <div className="bg-[#020617] relative selection:bg-blue-600/30 overflow-x-hidden min-h-screen text-slate-100">
            ...
            <section className="relative flex flex-col pt-16 pb-12 z-40 justify-center items-center border-b border-white/5">
                ...
                <div className="relative z-30 w-full px-6 max-w-7xl mx-auto flex flex-col items-center">
                    {/* Top Premium Badge */}
                    <div className="inline-flex items-center gap-2.5 px-5 py-1.5 bg-blue-500/10 border border-blue-500/30 rounded-full mb-8 backdrop-blur-md shadow-lg shadow-blue-500/5 hover:scale-[1.02] transition-transform">
                        <span className="w-1.5 h-1.5 bg-blue-400 rounded-full animate-ping" />
                        <span className="text-[10px] font-black tracking-[0.25em] text-blue-400 uppercase">Ecosystem Launch</span>
                    </div>

                    {/* Cinematic Bold Headline */}
                    <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-black italic uppercase tracking-tighter text-white text-center max-w-5xl leading-[0.9] mb-4">
                        Book Premium <span className="bg-gradient-to-r from-blue-400 to-indigo-500 bg-clip-text text-transparent">Sports</span> & <span className="bg-gradient-to-r from-purple-400 to-pink-500 bg-clip-text text-transparent">Gaming</span> Experiences
                    </h1>

                    {/* Subtitle */}
                    <p className="text-slate-400 font-black tracking-[0.25em] text-[10px] md:text-xs uppercase mt-4 mb-12 text-center border-y border-white/5 py-3 px-6">
                        Football <span className="text-blue-500 font-extrabold">•</span> Cricket <span className="text-blue-500 font-extrabold">•</span> Box Cricket <span className="text-purple-500 font-extrabold">•</span> Gaming Arenas
                    </p>
